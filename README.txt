...
This directory contains work tools and test files related to Dative XML.

.
├── dative-xml-test.xml    - sample Dative XML file
...
To validate the file dative-xml-test.xml against the RNC schema dative-xml.rnc
(and generate the RNG file dative-xml-rng in the process)::
